    ...
    if (monFichier.selection[0] && monFichier.selection[0].typename === "PathItem") {
     ...
     defaire = false;
              ...
              ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    var boiteDialogueCotation = new Window ('dialog', {en:"Dimension on a photo", fr:"Cotation sur photo"});
                    boiteDialogueCotation.alignChildren = "left";
                    boiteDialogueCotation.spacing = 5;
             /////// Scale
                    var grpValeur = boiteDialogueCotation.add('group');
                           var panValeur = grpValeur.add('panel', [0,0,145,60], {en:"Value", fr:"Valeur"});
             ...
             /////// Units
                   ...
                   var localiseUnit2 = {en:"inches", fr:"pouces"};
                   var localiseUnit4 = {en:"none", fr:"aucune"};
                            var listeUnites = panUnites.add('DropDownList',[10,15,92,34], ["mm", "cm", localiseUnit2, "pixels",localiseUnit4]);
             ...
             /////// User factor
                    var grpFormats  = boiteDialogueCotation.add('group')
                            var panFactUtil =grpFormats.add ('panel', [0,0,145,60], {en:"Coef adjustment", fr:"Coef ajustement"})
              ...
              /////// Colours
                    var panCouleurs = grpFormats.add ('panel', [0,0,105,60], {en:"Color", fr:"Couleur"})
                    ...
                    var listeCouleurs = panCouleurs.add('DropDownList', [10,15,92,34], [localiseColor0, "Magenta", "Cyan", localiseColor3, localiseColor4, localiseColor5]);
        ...
        alert(localize({en:"You must select a straight line.", fr:"Vous devez sélectionner un segment droit."}));
};
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//    Update preview    
...
// Unités
    choisirUnite(listeUnites.selection.index);
};
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//    Drraw the dimension    
