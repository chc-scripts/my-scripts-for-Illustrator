         ...
         /////// Call the function for creating the "Cotation" layer
                    ...
                    if(monType === "LIN"){
                     ...
                     /////// Height Text Offset (LIN)
                           var panRenvoiCoteH = grpRenvoi.add('panel', [0,0,224,80], "Height Text Offset");
                                    var rH = panRenvoiCoteH.add('radiobutton', [10,15,200,29], "Offset to the top");
                     ...
                     /////// Diameter (ALIG)
                           var ckbDiam = grpEchelle.add('checkBox', undefined,"Dimension a diameter");
                           ckbDiam.value=false;
                     /////// Direction (ALIG)
             ...
             /////// Symbol
                    var grpFormats  = boiteDialogueCotation.add('group')
                            var panSymboles = grpFormats.add ('panel', [0,0,105,60], "Symbol")
                                    var listeSymboles = panSymboles.add('DropDownList', [10,15,92,34], ["Arrow", "Dot", "Slash"]);
             ...
             /////// Attachment lines length
                    var grpLigne3=boiteDialogueCotation.add('group')
                            var panLongLigneAtt = grpLigne3.add('panel', [0,0,245,60], "Attachment Lines Length")
                                    ...
                                    fois5.helpTip = 'Choose the last level for the attachment lines length';
            ...
            /////// Load data saved in a previous session
             ...
             /////// Launching the initial dimension preview
                    majApercu();
             /////// Show the dialog box
...
////////// Transform the selected path into a dimension line (Change of its colour and thickness)
