...
// root window
var dlg = new Window("dialog", "Add Margin or Padding");
...
var rd_MargesUniformes = allMarginWrapper.add("radiobutton", undefined, "All");
...
//// Facing page processing
    var methodOptionsContainer = dlg.add("panel", undefined, "facing pages");
...
//// Appearance of margins
    var typeContainer = dlg.add("panel", undefined, "Create");
    ...
    var asGuide = typeContainer.add("radiobutton", undefined, "Guide");
        ...
        asGuide.onClick = function() {if (etat) { etat = false;};
                                                        majApercu();
                                                        majApercu();};
    var asMarge = typeContainer.add("radiobutton", undefined, "Margin");
        asMarge.onClick = function() { etat = true;
                                                        majApercu();};
//// "Create" button
    var grpBoutons = dlg.add("group", undefined);
    var renderBtn = grpBoutons.add("button", undefined, "Create", { name: 'ok' });
        renderBtn.alignment = configData.fillAlignment;
        renderBtn.helpTip = "Add margins or guides to the active document";
//// "Cancel" button
    var cancelBtn = grpBoutons.add("button", undefined, "Cancel");
