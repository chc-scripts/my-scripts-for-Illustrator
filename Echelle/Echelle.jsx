...
if (maSelection.length != 2) {
    alert(localize({en:"The selection must only include 2 distinct elements (objects or groups) in order to compare their dimensions.", fr:"La s\351lection ne doit comporter que 2 éléments distincts (objets ou groupes) afin de comparer leurs dimensions."}));
} else {
                        ...
                        var groupDimensions = groupSup.add("group", undefined); 
                                ...
                                //Width Group
                                    var groupLarg = groupDimensions.add("group", undefined); 
                                            ...
                                            var lblLargeur = groupLarg.add("statictext", [0,0,48,15], {fr:"\311chelle", en:"Width",});
                                            ...
                                            grpLargObjets.spacing = 8;
                                                   //Object_1 Width Group
                                                    ...
                                                    var lblLargObj_1 = grpLargObj_1.add("statictext", undefined, {en:"object_1", fr:"objet_1"}); 
                                             ...
                                             divider_h0.alignment = "fill"; 
                                                   //Object_2 Width Group
                                                    ...
                                                    var lblLargObj_2 = grpLargObj_2.add("statictext", undefined, {en:"object_2", fr:"objet_2"}); 
                                ...
                                //Height Group
                                    var groupHaut = groupDimensions.add("group", undefined); 
                                            ...
                                            var lblHauteur = groupHaut.add("statictext", [0,0,48,15], {en:"Height", fr:"Hauteur"});
                                            ...
                                            grpHautObjets.spacing = 10;
                                                   //Object_1 Height Group
                                                    ...
                                                    var lblHautObj_1 = grpHautObj_1.add("statictext", undefined, {en:"object_1", fr:"objet_1"}); 
                                            ...
                                            divider_h2.alignment = "fill"; 
                                                   //Object_1 Height Group
                                                    ...
                                                    var lblHautObj_2 = grpHautObj_2.add("statictext", undefined, {en:"object_2", fr:"objet_2"}); 
                    ...
                    //Radio Buttons Group
                        var groupRadioBtn = groupBoutons.add("group", undefined); 
                                ...
                                groupRadioBtn.spacing = 22;
                                        var rdbApercuLarg_1 = groupRadioBtn.add("radiobutton", undefined, {en:"Preview", fr:"Aper\347u"});
                                        ...
                                        var rdbApercuLarg_2 = groupRadioBtn.add("radiobutton", undefined, {en:"Preview", fr:"Aper\347u"});
                                        ...
                                        var rdbApercuHaut_1 = groupRadioBtn.add("radiobutton", undefined, {en:"Preview", fr:"Aper\347u"});
                                        ...
                                        var rdbApercuHaut_2 = groupRadioBtn.add("radiobutton", undefined, {en:"Preview", fr:"Aper\347u"});
    ...
    //Transformation Group
        var groupTransformation = boiteEchelle.add("group", undefined); 
                ...
                var lblTransform = groupTransformation.add("statictext", undefined, "Transformation");
                        ...
                        rdbGroupee = groupTransformation.add("radiobutton", undefined, {en:"All the Group", fr:"Tout le groupe"});
                        rdbGroupee.onClick = function () { majApercu()};
                var rdbRepartie = groupTransformation.add("radiobutton", undefined, {en:"Each Object", fr:"Chaque objet"});
...
var divider_h7 = boiteEchelle.add("panel"); 
    divider_h7.alignment = "fill"; 
        //Options Group
            var groupOptions = boiteEchelle.add("group", undefined);
                    var ckbContours = groupOptions.add("checkbox", undefined, {en:"Apply to strokes and effects \?", fr:"Appliquer aux contours et effets"});
                        ...
                        ckbContours.onClick = function () { ckbContours.value === true ? mesContours = 1 : mesContours = 0;
                            ...
                            var boutonAppliquer = groupOptions.add("button",undefined, {en:"Apply",fr:"Appliquer"},{name:'ok'});
                            boutonAppliquer.onClick = function() { boiteEchelle.close();};
                            var boutonAnnuler = groupOptions.add("button",undefined, {en:"Cancel", fr:"Annuler"},{name:'cancel'});
    ...
    alert (localize({en:"You can now select the objects to scale and\nthen click on one of the preview options.", fr:"Vous pouvez maintenant sélectionner\n les objets à mettre à l\'\351chelle puis\n cliquer sur l\'une des options d\'aper\347u."}));
};
