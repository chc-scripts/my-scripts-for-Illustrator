...
var grpUnit = dialog.add("group", undefined); 
    ...
    grpUnit.margins = 0; 
var statictext1 = grpUnit.add("statictext", undefined, "Unit"); 
var listeUnites = grpUnit.add("dropdownlist", undefined, ["mm","points","inches","pixels"]); 
...
//// Appliquer_au_texte ?
var ckbTexte = dialog.add("checkBox", undefined, "Including text ?");
...
var btnAnnuler = grpBoutons.add("button", undefined,  "Cancel"); 
